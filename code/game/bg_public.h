...
typedef enum {
	...
	WP_NULL_HAND, // WP_NULL_HAND			//	2	// 3/10/00 kef -- used to be WP_RAILGUN						// 1/1/06 TiM: used to be WP_1 

	WP_TRICORDER, // WP_TRICORDER			//	4
	WP_PADD, // WP_PADD 				//	8
	WP_COFFEE, // WP_COFFEE			//	16	// 3/13/00 kef -- used to be WP_PLASMAGUN					// 1/1/06 TiM: used to be WP_4 

	WP_PHASER, // WP_PHASER				//	32	// 3/13/00 kef -- used to be WP_LIGHTNING
	WP_COMPRESSION_RIFLE, // WP_COMPRESSION_RIFLE	//	64	// 3/13/00 kef -- added
	WP_TR116, // WP_TR116				//	128	// 3/13/00 kef -- added										// 1/1/06 TiM: used to be WP_7

	WP_GRENADE_LAUNCHER, // WP_GRENADE_LAUNCHER	//	256	// 3/10/00 kef -- used to be...heh...WP_8	// TiM: Hahaha I get it! hehe ;P
	WP_QUANTUM_BURST, // WP_QUANTUM_BURST		//	512	// 3/13/00 kef -- added
	WP_DISRUPTOR, // WP_DISRUPTOR			//	1024	// 3/13/00 kef -- used to be WP_ROCKET_LAUNCHER			// 1/1/06 TiM: used to be WP_10 

	WP_MEDKIT, // WP_MEDKIT				//	2048	// 10/12/00 jtd -- added for MP patch/gold - merges single player projectile and taser		// 1/1/06 TiM: used to be WP_11
	WP_VOYAGER_HYPO, // WP_VOYAGER_HYPO		//	4096	// 10/6/00 mcg -- added for MP patch/gold
	WP_DERMAL_REGEN, // WP_DERMAL_REGEN		//	8192	// 3/13/00 kef -- added									// 1/1/06 TiM: used to be WP_13
	
	WP_TOOLKIT, // WP_TOOLKIT				//	16384	// 10/12/00 jtd -- added for MP patch/gold					// 1/1/06 TiM: used to be WP_14
	WP_HYPERSPANNER, // WP_HYPERSPANNER				//	32768														// 1/1/06 TiM: used to be WP_NEUTRINO_PROBE
